 ...
 * [设计模式之适配器模式（补偿模式）](DesignPattern/TheAdapterPattern.md)
 * [设计模式之外观模式（补偿模式）](DesignPattern/TheFacadePattern.md)
 * [设计模式之装饰者模式](DesignPattern/TheDecoratorPattern.md)
 * [设计模式之工厂模式](DesignPattern/TheFactoryPattern.md)
 * [设计模式之享元模式](DesignPattern/TheFlyweightPattern.md)
 * [设计模式之单例模式](DesignPattern/TheSingletonPattern.md)
