...
| [TraeCode](https://www.trae.cn/) | Desktop<br>*[Agent / Sub-agents](https://docs.trae.cn/ide_agent-overview) 架构<br>可一键安装：[智能体列表](https://docs.trae.cn/ide_custom-agents-ready-for-one-click-import)* | ⭐️⭐️⭐️⭐️ |
| Qoder |  |  |
| CodeBuddy |  |  |
| Kimi Code |  |  |
| MiniMax Code |  |  |
