...
| 编程 Agent | 国家 | 产品形态 | 评级 |
| :--- | :--- | :--- | :--- |
| Codex<br>*CLI-Native Coding Agents* | 🇺🇸 | CLI / Ext / Desktop<br>*[Agent / Subagents](https://learn.chatgpt.com/docs/agent-configuration/subagents) 架构，可自动委派，也可通过 Agent（提示词）委派*<br>*~/.codex/AGENTS.md*<br>*{PROJECT_HOME}/AGENTS.md*<br>*{CURRENT_DIR}/AGENTS.md / Session Prompts*<br>*并行修改（Worktrees）支持完善*<br>*各形态各有短长* | ★★★☆☆ |
