...
| [GitHub Copilot](https://github.com/features/copilot)<br>*IDE-Integrated AI Editor/Extension* | 🇺🇸 | **Ext** / CLI / ~~Desktop~~<br>*Agent / Subagents 架构，可显式调用<br>高度 GitHub 定制化* | ⭐️⭐️⭐️ |
