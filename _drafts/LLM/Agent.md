...
| 办公 - *Work Agent* | ChatGPT Work<br>Claude Cowork<br>Genspark.ai<br>Perplexity.ai Computer<br>WorkBuddy📍<br>豆包工作<br>~~千问办公~~<br>~~百度搭子~~<br> | 全球AI发展趋势周报<br>自动操作微信发消息<br>视频内容总结<br>图片编辑<br>[一句话网页](https://htah4ugd.qwenwork.host/) |
...
OpenClaw 是一个开源的大语言模型**执行框架**。可以基于 [OpenClaw](https://openclaw.ai/) 开发自己的 Agent。
...
*⒋ 比如专家、专家团、技能包、技能套件等；有的产品也称其为 Agent（subagent），注意和执行时 [subagent](#-multi-agent) 概念的区别。*
