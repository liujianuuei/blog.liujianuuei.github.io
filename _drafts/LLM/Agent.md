...
| Cursor<br>*AI-Native IDE* | 🇺🇸 | Desktop / CLI / ~~Web~~<br>*[Agent / Subagents](https://cursor.com/cn/docs/subagents) 架构，可自动委派，也可显式调用*<br>![llm-agent-multi-agents-cursor.png](llm-agent-multi-agents-cursor.png) | ⭐️⭐️⭐️ |
