...
| [GitHub Copilot](https://docs.github.com/en/copilot/concepts/agents/cloud-agent/about-cloud-agent)<br>*IDE-Integrated AI Editor/Extension* | 🇺🇸 | Desktop / Ext / CLI |  |
| Cursor<br>*AI-Native IDE* | 🇺🇸 | Desktop / CLI / ~~Web~~<br>*[Agent / Subagents](https://cursor.com/cn/docs/subagents) 架构，可自动委派，也可显式调用* | ⭐️⭐️⭐️ |
...
| MiniMax Code | 🇨🇳 | Desktop<br>*体验一般* | ⭐️⭐️ |
| Kimi Code | 🇨🇳 | Desktop / CLI / Ext<br>*乏善可陈* | ⭐️ |
